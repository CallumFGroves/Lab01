...
NA means 'not available' and indicates missing data. In r, working with any missing value is usually contagious, the output is normally also 'NA'
...
**Write your answer here**
na.rm removes missing data from calculations and ignores them
...
**Write your answer here**
There may be some entries outliar entries with high turnouts. These would affect the mean more than the median.
